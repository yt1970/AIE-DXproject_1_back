...
def upgrade() -> None:
    ...
    with op.batch_alter_table("lectures", schema=None) as batch_op:
        batch_op.alter_column(
            "academic_year", existing_type=sa.Integer(), nullable=False
        )
        batch_op.alter_column(
            "term", existing_type=sa.String(length=50), nullable=False
        )
        batch_op.alter_column(
            "name", existing_type=sa.String(length=255), nullable=False
        )
        batch_op.alter_column(
            "session", existing_type=sa.String(length=50), nullable=False
        )
        batch_op.alter_column("lecture_on", existing_type=sa.Date(), nullable=False)

    # Update survey_batches table - foreign key
    with op.batch_alter_table("survey_batches", schema=None) as batch_op:
        batch_op.alter_column("lecture_id", existing_type=sa.Integer(), nullable=False)

    # Update survey_responses table - foreign key
    with op.batch_alter_table("survey_responses", schema=None) as batch_op:
        batch_op.alter_column(
            "survey_batch_id", existing_type=sa.BigInteger(), nullable=False
        )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("comment_summaries", schema=None) as batch_op:
        batch_op.alter_column(
            "survey_batch_id", existing_type=sa.BigInteger(), nullable=True
        )
    ...
    with op.batch_alter_table("survey_batches", schema=None) as batch_op:
        batch_op.alter_column("lecture_id", existing_type=sa.Integer(), nullable=True)

    # Revert lectures table
    with op.batch_alter_table("lectures", schema=None) as batch_op:
        batch_op.alter_column("lecture_on", existing_type=sa.Date(), nullable=True)
        batch_op.alter_column(
            "session", existing_type=sa.String(length=50), nullable=True
        )
        batch_op.alter_column(
            "name", existing_type=sa.String(length=255), nullable=True
        )
        batch_op.alter_column("term", existing_type=sa.String(length=50), nullable=True)
        batch_op.alter_column(
            "academic_year", existing_type=sa.Integer(), nullable=True
        )
