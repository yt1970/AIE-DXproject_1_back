...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('course_name', 'lecture_date', 'lecture_number', name='uq_course_lecture_instance')
    )
    ...
    sa.Column('comment_learned_raw', sa.Text(), nullable=True),
    sa.Column('comment_improvements_raw', sa.Text(), nullable=True),
