...
def upgrade() -> None:
    ...
    with op.batch_alter_table("lectures", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            "instructor_name", existing_type=sa.VARCHAR(length=255), nullable=False
        )
        batch_op.alter_column(
            "created_at",
            existing_type=sa.TIMESTAMP(),
        ...
        batch_op.create_unique_constraint(
            "uq_lecture_composite",
            ["academic_year", "term", "name", "session", "lecture_on"],
        )
    ...
    with op.batch_alter_table("response_comments", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("llm_importance", sa.String(length=10), nullable=True)
        )
        batch_op.alter_column(
            "survey_response_id",
            existing_type=sa.INTEGER(),
    ...
    with op.batch_alter_table("survey_responses", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("score_content_volume", sa.Integer(), nullable=False)
        )
        batch_op.add_column(
            sa.Column("score_content_understanding", sa.Integer(), nullable=False)
        )
        batch_op.add_column(
            sa.Column("score_content_announcement", sa.Integer(), nullable=False)
        )
        batch_op.add_column(
            sa.Column("score_instructor_overall", sa.Integer(), nullable=False)
        )
        batch_op.alter_column(
            "uploaded_file_id",
            existing_type=sa.INTEGER(),
        ...
        batch_op.alter_column(
            "account_id", existing_type=sa.VARCHAR(length=255), nullable=False
        )
        batch_op.alter_column(
            "score_satisfaction_overall", existing_type=sa.INTEGER(), nullable=False
        )
        batch_op.alter_column(
            "score_instructor_time", existing_type=sa.INTEGER(), nullable=False
        )
        batch_op.alter_column(
            "score_instructor_qa", existing_type=sa.INTEGER(), nullable=False
        )
        batch_op.alter_column(
            "score_instructor_speaking", existing_type=sa.INTEGER(), nullable=False
        )
        batch_op.alter_column(
            "score_self_preparation", existing_type=sa.INTEGER(), nullable=False
        )
        batch_op.alter_column(
            "score_self_motivation", existing_type=sa.INTEGER(), nullable=False
        )
        batch_op.alter_column(
            "score_self_future", existing_type=sa.INTEGER(), nullable=False
        )
        batch_op.alter_column(
            "score_recommend_friend", existing_type=sa.INTEGER(), nullable=False
        )
    ...
    with op.batch_alter_table("survey_summaries", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("nps", sa.DECIMAL(precision=5, scale=2), nullable=True)
        )
        ...
        batch_op.add_column(
            sa.Column(
                "avg_content_volume", sa.DECIMAL(precision=3, scale=2), nullable=True
            )
        )
        batch_op.add_column(
            sa.Column(
                "avg_content_understanding",
                sa.DECIMAL(precision=3, scale=2),
                nullable=True,
            )
        )
        ...
        batch_op.add_column(
            sa.Column(
                "avg_instructor_time", sa.DECIMAL(precision=3, scale=2), nullable=True
            )
        )
        batch_op.add_column(
            sa.Column(
                "avg_instructor_qa", sa.DECIMAL(precision=3, scale=2), nullable=True
            )
        )
        batch_op.add_column(
            sa.Column(
                "avg_instructor_speaking",
                sa.DECIMAL(precision=3, scale=2),
                nullable=True,
            )
        )
        batch_op.add_column(
            sa.Column(
                "avg_self_preparation", sa.DECIMAL(precision=3, scale=2), nullable=True
            )
        )
        batch_op.add_column(
            sa.Column(
                "avg_self_motivation", sa.DECIMAL(precision=3, scale=2), nullable=True
            )
        )
        batch_op.add_column(
            sa.Column(
                "avg_self_future", sa.DECIMAL(precision=3, scale=2), nullable=True
            )
        )
        batch_op.alter_column(
            "survey_batch_id",
        ...
        batch_op.alter_column(
            "response_count", existing_type=sa.INTEGER(), nullable=False
        )
        batch_op.alter_column(
            "created_at",
            existing_type=sa.TIMESTAMP(),
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("uploaded_files", schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint(
            "uq_course_lecture_instance",
            ["course_name", "lecture_date", "lecture_number"],
        )
        batch_op.alter_column(
            "finalized_at",
    ...
    with op.batch_alter_table("survey_summaries", schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint(
            "uq_survey_summary_batch_version",
            ["survey_batch_id", "analysis_version", "student_attribute"],
        )
        batch_op.alter_column(
            "created_at",
            existing_type=sa.DateTime(),
        ...
        batch_op.alter_column(
            "response_count", existing_type=sa.INTEGER(), nullable=True
        )
        batch_op.alter_column(
            "analysis_version",
            existing_type=sa.VARCHAR(length=20),
    ...
    with op.batch_alter_table("survey_responses", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column(
                "score_satisfaction_instructor_clarity", sa.INTEGER(), nullable=True
            )
        )
        batch_op.add_column(
            sa.Column(
                "score_satisfaction_instructor_overall", sa.INTEGER(), nullable=True
            )
        )
        batch_op.add_column(
            sa.Column(
        ...
        batch_op.create_index(
            "ix_survey_responses_survey_batch_id", ["survey_batch_id"], unique=False
        )
        batch_op.create_index(
            "ix_survey_responses_account_id", ["account_id"], unique=False
        )
        batch_op.alter_column(
            "score_recommend_friend", existing_type=sa.INTEGER(), nullable=True
        )
        batch_op.alter_column(
            "score_self_future", existing_type=sa.INTEGER(), nullable=True
        )
        batch_op.alter_column(
            "score_self_motivation", existing_type=sa.INTEGER(), nullable=True
        )
        batch_op.alter_column(
            "score_self_preparation", existing_type=sa.INTEGER(), nullable=True
        )
        batch_op.alter_column(
            "score_instructor_speaking", existing_type=sa.INTEGER(), nullable=True
        )
        batch_op.alter_column(
            "score_instructor_qa", existing_type=sa.INTEGER(), nullable=True
        )
        batch_op.alter_column(
            "score_instructor_time", existing_type=sa.INTEGER(), nullable=True
        )
        batch_op.alter_column(
            "score_satisfaction_overall", existing_type=sa.INTEGER(), nullable=True
        )
        batch_op.alter_column(
            "account_id", existing_type=sa.VARCHAR(length=255), nullable=True
        )
        batch_op.alter_column(
            "survey_batch_id",
            existing_type=sa.BigInteger(),
    ...
    with op.batch_alter_table("score_distributions", schema=None) as batch_op:
        batch_op.create_unique_constraint(
            "uq_score_distribution_entry",
            ["survey_batch_id", "student_attribute", "question_key", "score_value"],
        )
        batch_op.alter_column(
            "survey_batch_id",
            existing_type=sa.BigInteger(),
    ...
    with op.batch_alter_table("response_comments", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("llm_importance_level", sa.VARCHAR(length=20), nullable=True)
        )
        batch_op.create_index(
            "ix_response_comments_survey_batch_id", ["survey_batch_id"], unique=False
        )
        batch_op.create_index(
            "ix_response_comments_account_id", ["account_id"], unique=False
        )
        batch_op.alter_column(
            "processed_at",
            existing_type=sa.DateTime(),
    ...
    with op.batch_alter_table("lectures", schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint(
            "uq_lecture_identity",
            ["name", "academic_year", "term", "session", "lecture_date"],
        )
        batch_op.alter_column(
            "updated_at",
            existing_type=sa.DateTime(),
        ...
        batch_op.alter_column(
            "instructor_name", existing_type=sa.VARCHAR(length=255), nullable=True
        )
        batch_op.drop_column("lecture_on")
