from sqlalchemy import Column, Integer, String, Date, TIMESTAMP, UniqueConstraint, Text, ForeignKey
...
class UploadedFile(Base):
    ...
    __table_args__ = (
        UniqueConstraint('course_name', 'lecture_date', 'lecture_number', name='uq_course_lecture_instance'),
    )
